...
Система должна хранить данные о прачечных, пользователях и их заказах.

12.2. Требования к представлению информации:

Доступ к данным осуществляется посредством взаимодействия с веб-клиентом.
...
Для демонстрации работоспособности системы база данных заполнена тестовыми данными.

13.2. Требования к источникам информации:

Информацию предоставляют администраторы и клиенты сервиса.
