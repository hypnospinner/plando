  ...
  module.exports = {
    ...
    rules: {
      ...
      eqeqeq: [types.ERROR,
        ...
        "grouped-accessor-pairs": [types.WARN,
            "setBeforeGet"
        ],
        ...
        "no-mixed-spaces-and-tabs": [types.ERROR,
            "smart-tabs"
        ],
        "no-useless-return": types.WARN,
        "no-extra-parens": types.OFF,
        "arrow-body-style": [types.ERROR,
            "always"
        ],
        "arrow-parens": [types.ERROR,
            "as-needed"
        ],
        ...
        "func-call-spacing": [types.ERROR,
            "never"
        ],
        "prettier/prettier": [types.ERROR,
            {
                "singleQuote": true
            }
        ],
        ...
        "@typescript-eslint/func-call-spacing": [types.ERROR,
            "never"
        ],
